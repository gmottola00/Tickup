...
namespace Tanks.Complete
{
    public class GameManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private bool m_AutoRestartScene = true;
        ...
        public event Action<TankManager, int> RoundEnded;     // Fired when a round concludes (winner can be null for draw)
        public event Action<TankManager> GameEnded;            // Fired when a player wins the game

        public bool AutoRestartScene
        {
            get => m_AutoRestartScene;
        ...
        private IEnumerator GameLoop ()
        {
            ...
            {
                GameEnded?.Invoke(m_GameWinner);

                // If there is a game winner, restart the level.
                if (m_AutoRestartScene)
        ...
        private IEnumerator RoundEnding ()
        {
            ...
            RoundEnded?.Invoke(m_RoundWinner, m_RoundNumber);
        }
